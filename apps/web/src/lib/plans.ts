...
export const PLANS: Record<PlanId, Plan> = {
  free: {
    ...
    priceAnnual: 0,
    badge: null,
    limits: { pages: 3, views: 200, qr: 1, team: null },
    caps: { printStudio: false, qrStudioAdvanced: false, ai: false, removeBranding: false, pageIntro: false, exportFormats: ["png"] },
    features: ["3 pages", "200 vues/mois", "1 QR statique + 2 dynamiques/mois", "Branding QRowg visible", "Analytics de base", "6 templates gratuits"],
    perks: [
      { text: "3 pages", included: true },
      { text: "200 vues / mois", included: true },
      { text: "1 QR statique permanent", included: true },
...
export const PLAN_COMPARISON: { feature: string; free: string; starter: string; pro: string; business: string }[] = [
  ...
  { feature: "QR codes", free: "1 statique + 2 dyn./mois", starter: "7 personnalisés", pro: "35 avancés", business: "Illimités" },
