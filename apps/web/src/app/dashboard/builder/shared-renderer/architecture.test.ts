...
describe("flag de migration — 93 blocs activés (pilotes + vagues 1 à 9)", () => {
  ...
  it("exactement les 93 blocs sont activés", () => {
    expect([...SHARED_RENDERER_BLOCKS].sort()).toEqual([...ACTIVE].sort())
  })
  it("resolveRendererStatus : shared pour les 93 actifs, legacy pour les autres", () => {
