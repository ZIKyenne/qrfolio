...
describe("flag & statut de migration (45 blocs activés)", () => {
  it("exactement les 45 blocs sont dans le flag actif", () => {
    expect([...SHARED_RENDERER_BLOCKS].sort()).toEqual([...ACTIVE].sort())
  })
  it("statut : shared pour les 45 actifs, legacy pour tous les autres", () => {
...
describe("résolution éditeur/public (flag actif = 45 blocs)", () => {
  it("les 45 blocs sont résolus vers un adapter (éditeur ET public), les autres non", () => {
