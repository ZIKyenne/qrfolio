...
describe("flag de migration — 33 blocs activés (pilotes + vagues 1 à 5)", () => {
  ...
  it("exactement les 33 blocs sont activés", () => {
    expect([...SHARED_RENDERER_BLOCKS].sort()).toEqual([...ACTIVE].sort())
  })
  it("resolveRendererStatus : shared pour les 33 actifs, legacy pour les autres", () => {
