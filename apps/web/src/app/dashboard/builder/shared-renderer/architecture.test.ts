...
describe("flag de migration — 27 blocs activés (pilotes + vagues 1 à 4)", () => {
  ...
  it("exactement les 27 blocs sont activés", () => {
    expect([...SHARED_RENDERER_BLOCKS].sort()).toEqual([...ACTIVE].sort())
  })
  it("resolveRendererStatus : shared pour les 27 actifs, legacy pour les autres", () => {
