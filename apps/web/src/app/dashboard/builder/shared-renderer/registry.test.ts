...
const ACTIVE = new Set(["heading", "values", "pricing", "divider", "spacer", "bio", "skills", "languages", "advantages", "whatsapp_button", "email_button", "download_file", "order_online", "donation", "google_review", "process_steps", "on_site_services", "engagements", "trust_badge", "stats_block", "event_program"])

describe("flag & statut de migration (21 blocs activés)", () => {
  it("exactement les 21 blocs sont dans le flag actif", () => {
    expect([...SHARED_RENDERER_BLOCKS].sort()).toEqual([...ACTIVE].sort())
  })
  it("statut : shared pour les 21 actifs, legacy pour tous les autres", () => {
...
describe("résolution éditeur/public (flag actif = 21 blocs)", () => {
  it("les 21 blocs sont résolus vers un adapter (éditeur ET public), les autres non", () => {
