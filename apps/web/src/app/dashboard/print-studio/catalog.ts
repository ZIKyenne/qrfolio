...
const ITEMS: Item[] = [
  ...
  { id: 'i2', hMm: 70, fold: true, place: 'Table', scene: 'comptoir', layout: 'band', name: 'Chevalet de table', support: 'Carte de table', size: '100 × 70 mm', bleed: 3, margin: 4, dpi: 300, shape: 'rect', ratio: 100 / 70, plain: 'Debout entre le sel et le poivre : menu, avis ou réservation, sans rien demander.', kicker: 'Commandez ici', title: 'À table', cta: 'Voir le menu', qrMm: 30, pal: 'restofresh' },
