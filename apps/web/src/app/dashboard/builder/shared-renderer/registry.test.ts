...
const ACTIVE = new Set(["heading", "values", "pricing", "divider", "spacer", "bio", "skills", "languages", "advantages", "whatsapp_button", "email_button", "download_file", "order_online", "donation", "google_review", "process_steps", "on_site_services", "engagements", "trust_badge", "stats_block", "event_program", "testimonials", "business_stats", "brands", "lineup", "reassurance", "timeline", "menu_section", "services_list", "promo_banner", "gift_card", "event_info", "event_ticketing", "image", "portfolio_work", "favorite_links", "concerts", "merch", "app_download"])

describe("flag & statut de migration (39 blocs activés)", () => {
  it("exactement les 39 blocs sont dans le flag actif", () => {
    expect([...SHARED_RENDERER_BLOCKS].sort()).toEqual([...ACTIVE].sort())
  })
  it("statut : shared pour les 39 actifs, legacy pour tous les autres", () => {
...
describe("résolution éditeur/public (flag actif = 39 blocs)", () => {
  it("les 39 blocs sont résolus vers un adapter (éditeur ET public), les autres non", () => {
