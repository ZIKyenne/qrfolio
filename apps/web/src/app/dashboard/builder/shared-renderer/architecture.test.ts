...
describe("flag de migration — 86 blocs activés (pilotes + vagues 1 à 8)", () => {
  ...
  it("exactement les 86 blocs sont activés", () => {
    expect([...SHARED_RENDERER_BLOCKS].sort()).toEqual([...ACTIVE].sort())
  })
  it("resolveRendererStatus : shared pour les 86 actifs, legacy pour les autres", () => {
