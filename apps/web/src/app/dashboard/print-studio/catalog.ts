...
export type Item = {
  ...
  /**
   * Distance à laquelle ce support est réellement scanné, en centimètres.
   *
   * Ce n'était écrit nulle part, et les gabarits se contredisaient : l'affiche
   * A3 promettait « un QR lisible à deux mètres » avec un code de 68 mm, qui se
   * lit à 68 cm. L'affiche A2 promettait cinq mètres, ce qui demanderait un QR
   * de 500 mm sur une feuille large de 420 — impossible.
   *
   * La règle, la même que celle du preflight (printPreflight.scanDistanceM) et
   * de l'outil public : le côté du QR vaut environ un dixième de la distance de
   * lecture. Un test refuse tout support dont le QR ne tient pas sa distance.
   */
  distanceCm: number;
}
...
const ITEMS: Item[] = [
  ...
  { id: 'i8', hMm: 420, place: 'Mur', scene: 'mur', layout: 'poster', name: 'Affiche A3', support: 'A3', size: '297 × 420 mm', bleed: 3, margin: 6, dpi: 200, shape: 'rect', ratio: 297 / 420, plain: 'Visible de loin : événement, ouverture, soirée — un QR lisible à un bon mètre.', kicker: 'Samedi 21 h', title: 'Soirée jazz', cta: 'Réservez', distanceCm: 120, qrMm: 120, pal: 'neon' },
  { id: 'i9', hMm: 160, place: 'Comptoir', scene: 'comptoir', layout: 'stack', name: 'Marque-page', support: 'Marque-page', size: '55 × 160 mm', bleed: 2, margin: 4, dpi: 300, shape: 'rect', ratio: 55 / 160, plain: 'Glissé dans le sac ou le livre : votre page reste à portée de scan.', kicker: 'Suivez-nous', title: 'Restons liés', cta: 'En savoir plus', distanceCm: 25, qrMm: 30, pal: 'sage' },
  { id: 'i10', hMm: 95, place: 'Table', scene: 'table', layout: 'centre', name: 'Sous-bock', support: 'Sous-bock rond', size: 'Ø 95 mm', bleed: 3, margin: 5, dpi: 300, shape: 'round', ratio: 1, plain: 'Sous chaque verre : la carte des boissons arrive avant le serveur.', kicker: 'Au comptoir', title: 'Cocktails', cta: 'Voir la carte', distanceCm: 30, qrMm: 42, pal: 'barnoir' },
  { id: 'i11', hMm: 297, place: 'Table', scene: 'comptoir', layout: 'orne', name: 'Porte-menu A4', support: 'A4 · porte-menu', size: '210 × 297 mm', bleed: 3, margin: 8, dpi: 300, shape: 'rect', ratio: 210 / 297, plain: 'Glissé dans le porte-menu : la carte complète, mise à jour sans réimprimer.', kicker: 'Café Lune', title: 'La carte', cta: 'Tout voir', distanceCm: 35, qrMm: 58, pal: 'menuclair' },
  { id: 'i12', hMm: 90, place: 'Comptoir', scene: 'comptoir', layout: 'footer', name: 'Étiquette bouteille', support: 'Étiquette', size: '60 × 90 mm', bleed: 2, margin: 3, dpi: 600, shape: 'rect', ratio: 60 / 90, plain: 'Collée sur le flacon : l\'origine, le producteur et l\'histoire au dos du scan.', kicker: 'Domaine', title: 'Cuvée 2024', cta: 'Notre histoire', distanceCm: 20, qrMm: 24, pal: 'sage' },
  { id: 'i13', hMm: 55, place: 'Main', scene: 'main', layout: 'colonnes', name: 'Carte de fidélité', support: 'Carte paysage', size: '85 × 55 mm', bleed: 2, margin: 3, dpi: 300, shape: 'rect', ratio: 85 / 55, plain: 'Dans le portefeuille : les points se comptent en scannant, plus de tampons.', kicker: 'Fidélité', title: 'Votre carte', cta: 'Vos points', distanceCm: 20, qrMm: 22, pal: 'airbnb' },
  { id: 'i14', hMm: 2000, place: 'Mur', scene: 'mur', layout: 'affiche', name: 'Roll-up', support: 'Roll-up', size: '850 × 2000 mm', bleed: 20, margin: 40, dpi: 150, shape: 'rect', ratio: 850 / 2000, plain: 'Déployé à l\'entrée : visible de loin, scannable de près.', kicker: 'Portes ouvertes', title: 'Bienvenue', cta: 'Le programme', distanceCm: 200, qrMm: 220, pal: 'corporate' },
  { id: 'i15', hMm: 594, place: 'Mur', scene: 'mur', layout: 'diagonale', name: 'Affiche A2', support: 'A2', size: '420 × 594 mm', bleed: 5, margin: 10, dpi: 200, shape: 'rect', ratio: 420 / 594, plain: 'Sur la vitre ou le mur : une offre qui se lit à deux mètres.', kicker: 'Nouvelle saison', title: 'Rejoignez-nous', cta: 'Premier cours offert', distanceCm: 200, qrMm: 200, pal: 'neon' },
  { id: 'i16', hMm: 210, place: 'Vitrine', scene: 'vitrine', layout: 'cadre', name: 'Panneau horaires', support: 'A5 · panneau', size: '148 × 210 mm', bleed: 3, margin: 5, dpi: 300, shape: 'rect', ratio: 148 / 210, plain: 'Sur la porte : horaires, garde et coordonnées, toujours à jour.', kicker: 'Infos pratiques', title: 'Nos horaires', cta: 'Tout savoir', distanceCm: 60, qrMm: 60, pal: 'contactclair' },
]
